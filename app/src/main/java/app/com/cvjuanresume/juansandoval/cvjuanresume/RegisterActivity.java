...
/**
 * Created by jsandoval on 21/04/17.
 */
...
import app.com.cvjuanresume.juansandoval.cvjuanresume.utils.AppConfig;
import app.com.cvjuanresume.juansandoval.cvjuanresume.utils.AppController;
            ...
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
                    ...
                    Toast.makeText(getApplicationContext(),
                            R.string.register_details, Toast.LENGTH_LONG)
                            .show();
                }
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Toast.makeText(getApplicationContext(), R.string.succesfull_register, Toast.LENGTH_LONG).show();
